...
class Circle:
    ...
    def laguerre_distance_to(self, other):
        return np.square(self.distance_to(other)) - np.square(
    ...
    def contains_point(self, point) -> bool:
        return bool(self.distance_to_point(point) < 0.0)
    ...
    def __eq__(self, other):
        return bool(np.all(self.centre == other.centre) and self.radius == other.radius)
